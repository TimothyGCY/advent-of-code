...
public class Day05 extends Solution {
    ...
    private static final List<String> twice = List.of("aa", "bb", "cc", "dd", "ee", "ff", "gg", "hh", "ii", "jj", "kk", "ll", "mm", "nn", "oo", "pp", "qq", "rr", "ss", "tt", "uu", "vv", "ww", "xx", "yy", "zz");
    ...
    public int solvePart1() {
        ...
        return data.stream().filter(l -> {
            String v = l.chars().mapToObj(c -> (char) c)
